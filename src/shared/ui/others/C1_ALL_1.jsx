        ...
        <g id="C1.3">
          <g>
            ...
            <g className="map-groups-rooms">
              <g
                id="DININGHALL"
                data-name="DININGHALL|АСХАНА|СТОЛОВАЯ|СТОЛОВКА"
              >
          ...
          <g className="map-groups-rooms">
            <g id="C1.3.188" data-name="C1.3.188" fill={getClassroomColor("C1.3.188")} onClick={() => onClassroomClick("C1.3.188")}>
            ...
            <g id="C1.3.187" data-name="C1.3.187" onClick={() => onClassroomClick("C1.3.187")}>
              <polyline fill={getClassroomColor("C1.3.187")} points="614.76 247.78 614.22 250.61 666.5 260.68 671.88 235.32 644.74 229.72 642.32 241.36 644.74 229.72 629.43 226.57 625.81 244.74 641.25 247.83 621.06 243.78 625.81 244.74 628.46 231.48 618.27 229.32 615.25 245.19" />
              <path
        ...
        <g id="C1.1">
          ...
          <g className="map-groups-rooms">
            ...
            <g data-name="LIBRARY|BIBLIOTEKA|БИБЛИОТЕКА|МЕДИАТЕКА|MEDIATEKA|KITAPHANA|КІТАПХАНА">
              <polyline className={getClassroomColor("LIBRARY|BIBLIOTEKA|БИБЛИОТЕКА|МЕДИАТЕКА|MEDIATEKA|KITAPHANA|КІТАПХАНА")} points="149.8 232.96 184.64 334.68 168.11 340.2 179.31 370.29 119.83 394.87 5.48 188.49 1 172.49 3.55 158.73 12.36 147.66 26.52 138.86 41.12 132.98 84.63 221.4 123.9 206.34 130.07 222.03 144.44 217.3 146.8 224.15" />
              <path
